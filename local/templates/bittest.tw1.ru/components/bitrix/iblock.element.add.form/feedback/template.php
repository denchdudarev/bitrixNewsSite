...
<section class="home-feedback" style="background-image: url('../src/img/feedback-bg.jpg')">
    <div class="container">
        ...
        <form class="home-feedback__form" name="iblock_add" action="<?= POST_FORM_ACTION_URI ?>" method="post"
            ...
            <? if ($arParams["MAX_FILE_SIZE"] > 0): ?><input type="hidden" name="MAX_FILE_SIZE"
                ...
                <? endif ?>
                        <div class="home-feedback__btn">
                            <input class="btn btn_feedback-send" type="submit" name="iblock_submit"
